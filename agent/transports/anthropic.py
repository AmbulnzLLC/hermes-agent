...
class AnthropicTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        params also accepts guardrail_config: dict | None — Bedrock guardrails, consumed below
        rather than by build_anthropic_kwargs. Caller gates on Bedrock, not this transport.
        """
