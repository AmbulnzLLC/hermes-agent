...
def init_agent(
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if _is_bedrock_anthropic:
            ...
            # call. Without this, `bedrock.guardrail.*` config is silently
            # dropped on Claude models because the AnthropicBedrock SDK doesn't
            # accept `guardrailConfig` natively — it must be sent via
            # X-Amzn-Bedrock-Guardrail* headers.
